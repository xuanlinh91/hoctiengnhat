...
?>
    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1>Course <small>Edit Grammar</small></h1>
                <ol class="breadcrumb">
        ...
        <div class="fld">
            ...
            <div class="form-group">
                ...
                <input type="hidden" class="form-control" value="<?php echo isset($gram['id']) && !empty($gram['id']) ? $gram['id'] : '';?>" name="id">
                <div class="col-sm-8 col-md-6 col-lg-8">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8 col-md-6 col-lg-8">
                    <textarea class="text-counter-js form-control" rows="5" cols="10" maxlength="200" name="preview"><?php echo isset($gram['preview']) && !empty($gram['preview']) ? trim($gram['preview']) : '';?></textarea>
                </div>
            </div>
